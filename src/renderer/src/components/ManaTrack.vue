  ...
  <div class="container">
    <div v-if="showMask" class="mask">
      <form @submit.prevent="save">
        ...
        <label>Typ:
          <input type="radio" value="Einnahme" v-model="typ" /> Einnahme
          <input type="radio" value="Ausgabe" v-model="typ" /> Ausgabe
        </label><br />
        <label>Wiederholung:
        ...
        <label>Startdatum:
          <input v-model="startdatum" type="date" />
        </label><br />
        <label>Notiz (optional):
          <input v-model="notiz" type="text" />
        </label><br />
